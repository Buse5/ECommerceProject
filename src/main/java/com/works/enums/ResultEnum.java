...
public enum ResultEnum {
    ...
    BOOK_NOT_EXIST(10, "Book does not exit!"),
    BOOK_NOT_ENOUGH(11, "Not enough book in stock!"),
    BOOK_STATUS_ERROR(12, "Status is incorrect!"),
    BOOK_OFF_SALE(13,"Book is off sale!"),
    BOOK_NOT_IN_CART(14,"Book is not in the cart!"),
